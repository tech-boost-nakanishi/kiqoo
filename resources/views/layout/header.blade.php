    ...
    <div class="container">
        <div class="row">
            <header class="col-md-10 col-xs-12">
               ...
               <a href="#" data-toggle="modal" data-target="#searchModal" style="font-size: 24px; margin: 0;"><i class="fas fa-search"></i></a>
                <ul class="right-nav">
                    @guest
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">キーワードで検索</h4>
            </div>
